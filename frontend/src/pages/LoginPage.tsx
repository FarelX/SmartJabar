...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen min-h-dvh bg-mesh flex items-center justify-center px-4 py-8 sm:p-6 lg:p-10 relative">
      {/* Decorative background orbs — smaller on mobile to avoid fill rate pressure */}
      <div className="absolute top-1/4 left-1/3 w-48 h-48 sm:w-96 sm:h-96 bg-primary-500/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/3 w-48 h-48 sm:w-96 sm:h-96 bg-teal-500/10 rounded-full blur-3xl pointer-events-none" />

      {/* Main Centered Container */}
      <div className="relative z-10 w-full max-w-4xl grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">

        {/* Panel Kiri — Login Form (7 cols on lg) */}
        <div className="lg:col-span-7 flex flex-col justify-center">
          ...
          <div className="flex items-center gap-3 sm:gap-3.5 mb-6 sm:mb-8">
            <img
              ...
              alt="SMART JABAR"
              className="h-11 w-11 sm:h-14 sm:w-14 rounded-2xl border border-slate-200/80 shadow-md shadow-primary-500/10 shrink-0"
            />
            <div>
              ...
              <p className="text-slate-500 text-[11px] sm:text-xs mt-0.5 font-medium leading-tight">
          ...
          {/* SSO Action Box */}
          <div className="p-5 sm:p-6 lg:p-7 mb-5 sm:mb-6 bg-white/95 backdrop-blur-xl border border-slate-200/90 shadow-xl rounded-2xl">
            <div className="mb-5 sm:mb-6">
              <h2 className="text-slate-900 text-xl sm:text-2xl font-bold mb-2">
                Selamat Datang
              </h2>
              <p className="text-slate-600 text-xs sm:text-sm leading-relaxed">
                Masuk menggunakan akun Single Sign-On (SSO) Jawa Barat untuk mengakses
            ...
            <Button
              ...
              className="w-full h-11 sm:h-12 bg-gradient-to-r from-primary-600 to-teal-600 hover:from-primary-500 hover:to-teal-500 text-white font-semibold text-sm sm:text-base rounded-xl shadow-md shadow-primary-500/25 hover:shadow-primary-500/35 transition-all duration-300 group cursor-pointer"
            >
              <Shield className="mr-2 h-4 w-4 sm:h-5 sm:w-5 shrink-0" />
              Masuk dengan SSO
          ...
          {/* Help link & Copyright */}
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-3 text-xs">
            <a
        ...
        {/* Panel Kanan — Info/Branding Card (5 cols, hidden on mobile & tablet) */}
